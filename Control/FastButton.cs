...
{
    public class FastButton : UIComponent
    {
        ...
        public FastButton(Font font, uint size, Texture button, Texture hover, Texture press)
        {
            ...
            text = new FastText(font, size) { TextAlignment = Alignment.MiddleCenter, Bold = true };
        ...
        public FastButton(Font font, uint size, string button, string hover, string press)
            : this(font, size, new Texture(button)
            {
                Smooth = true
            },
            new Texture(hover)
